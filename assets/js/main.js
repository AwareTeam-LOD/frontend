...
function initialize() {
        ...
        var marker = WE.marker([105, 52.09]).addTo(earth);
        marker.bindPopup("<b>Снимок №12</b><br>12.02.2021 <br><a href='see.html#12'>Открыть</a>", {maxWidth: 150, closeButton: true}).openPopup();

        var marker2 = WE.marker([130, 46.228889]).addTo(earth);
        marker2.bindPopup("<b>Снимок №13</b><br>12.02.2021 <br><a href='see.html#13'>Открыть</a>", {maxWidth: 120, closeButton: false});

        var marker3 = WE.marker([120, 56.228889]).addTo(earth);
        marker2.bindPopup("<b>Снимок №14</b><br>12.02.2021 <br><a href='see.html#14'>Открыть</a>", {maxWidth: 120, closeButton: false});

        var marker4 = WE.marker([150, 67.228889]).addTo(earth);
        marker2.bindPopup("<b>Снимок №15</b><br>12.02.2021 <br><a href='see.html#15'>Открыть</a>", {maxWidth: 120, closeButton: false});

        var marker5 = WE.marker([160, 75.228889]).addTo(earth);
        marker2.bindPopup("<b>Снимок №16</b><br>12.02.2021 <br><a href='see.html#16'>Открыть</a>", {maxWidth: 120, closeButton: false});
